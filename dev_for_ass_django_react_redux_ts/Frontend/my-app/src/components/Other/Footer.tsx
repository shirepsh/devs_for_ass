        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-4 mb-5 mb-lg-0 ">
              ...
              <a className="btn-social mx-1" style={{color:"white"}}  href="https://www.linkedin.com/in/shir-epshtain-55724b248/?trk=public_profile-settings_edit-profile-content&originalSubdomain=il">
                <FaLinkedin />
              </a>
